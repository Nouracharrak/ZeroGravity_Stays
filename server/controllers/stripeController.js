...
const { sendPaymentConfirmationEmail } = require('../config/mailer');

/**
 * Crée un Payment Intent et renvoie le client secret
 */
exports.createPaymentIntent = async (req, res) => {
    ...
    try {
        // Créer le Payment Intent directement avec Stripe
...
/**
 * Traite la confirmation d'un paiement réussi
 */
