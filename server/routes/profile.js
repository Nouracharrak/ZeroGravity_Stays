...
// Configuration de multer avec des limites - IMPORTANT: ne pas chaîner .single() ici
const upload = multer({
  storage,
  limits: {
...
// Utilisation correcte de upload.single() comme middleware
...
router.put("/:id", verifyToken, async (req, res) => {
  try {
    ...
    // Vérification des droits d'admin (à implémenter selon votre logique)
    // ...
    
    // Sécuriser les champs à mettre à jour
    const allowedFields = ['firstName', 'lastName', 'isActive', 'role'];
    const updateData = {};
